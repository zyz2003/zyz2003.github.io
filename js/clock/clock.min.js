...
'  </div>';var week = ["SUN","MON","TUE","WED","THU","FRI","SAT"];var card_clock_loading_dom = document.getElementById("card-clock-loading");if (card_clock_loading_dom){card_clock_loading_dom.innerHTML = ""}clock_box.innerHTML = clock_box_html;function updateTime(){var cd = new Date();var card_clock_time =
